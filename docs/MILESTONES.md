...
| M9B | Validate Palladio semantics on independent hand-checkable reliability controls | In progress | controls cover serial failure, fallback, redundancy, shared domains, communication failure, and conditional execution before any M7 mapping |
