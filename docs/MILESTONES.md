...
| M9G | Recover the pinned PMX launcher route and measure the application adapter/information delta on a separate track | Next | Dual-track protocol to be frozen after M9F; no accuracy scoring or new live collection |
