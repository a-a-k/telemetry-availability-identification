...
| M9O | Preregister matched independent temporal confirmation and size the prospective campaign matrix | Complete as design; confirmation pending | `milestones/M9O_TEMPORAL_CONFIRMATION_DESIGN.md`; first-attempt run 34113304974 selected and audited 30 repetitions per stratum, 120 fresh campaigns, with 62 nominal runner-hours and a separate no-fit preflight gate |
| M9P | Independent temporal confirmation with separate no-fit preflight | In progress; main acquisition running | `milestones/M9P_NO_FIT_PREFLIGHT.md`; accepted preflight 34115470738; frozen 120-cell main run 34118845320 at bc03711b3a50daa90be305986dd12769a2d8ef30 is collecting fresh campaigns |
