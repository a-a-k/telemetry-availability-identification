...
| M9F | Audit reproducibility and semantic fit of the PMX performability route before choosing a manual continuation | In progress | `M9F_PMX_PERFORMABILITY_AUDIT_PROTOCOL.md` and its remote three-job workflow are frozen before the first PMX execution; no accuracy scoring or new live collection |
