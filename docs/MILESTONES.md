...
| M9I | Audit embedded PMX failure-detection semantics against the retained M9H input/log boundary | In preparation | Static/source and retained-evidence diagnostic only; no accuracy, M7 evaluator, dynamic control search, or new collection |
