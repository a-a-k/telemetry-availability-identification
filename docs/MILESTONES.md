...
| M9H | Test the exact source-declared PMX `main:main` entrypoint and frozen failure mechanism | Next | Prospective follow-up to M9G's embedded DS evidence; the manual PCM route remains separately labelled |
