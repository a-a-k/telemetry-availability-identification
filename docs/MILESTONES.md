...
| M9J | Test the exact source-implied surviving-carrier failure contract | In preparation | Matched carrier `error="false"`/`error="true"` controls plus the retained child-error witness; independent 0 versus 0.1 mechanism oracles, no application accuracy or new collection |
