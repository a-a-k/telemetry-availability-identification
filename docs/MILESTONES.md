...
| M9K | Localize the retained proposed-model overprediction on one operation | Preregistered; remote run pending | Checkout fixed from M8B before re-opening evidence; exact three-term decomposition on 40 retained N/ND campaigns, with no tuning, PMX invocation, or new collection |
