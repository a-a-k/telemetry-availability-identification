...
| M9Q | Qualify an explicit observed-operation adapter for the recovered PMX route | In progress; artificial contract implemented | `M9Q_PMX_OBSERVED_OPERATION_PROTOCOL.md`; three synthetic cases with two technical repeats, followed by the gated four-sample historical learner census; no M9P data or availability scoring |
