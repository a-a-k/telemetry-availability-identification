...
| M9G | Recover the pinned PMX launcher route and measure the application adapter/information delta on a separate track | Protocol frozen; remote run pending | `M9G_PMX_RECOVERY_AND_APPLICATION_DELTA_PROTOCOL.md`; four ordered Gogo screens, a separate 160-bundle learner audit, exactly three 360-minute jobs, no accuracy scoring or new live collection |
