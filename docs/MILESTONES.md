...
| M9F | Audit reproducibility and semantic fit of the PMX performability route before choosing a manual continuation | In progress | Protocol and remote three-job workflow to be frozen after the post-M9E source/artifact audit; no accuracy scoring or new live collection |
