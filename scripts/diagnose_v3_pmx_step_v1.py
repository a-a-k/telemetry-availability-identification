...
OUT = Path('workflow-results/pmx-step-diagnostic')
...
def main():
    ...
    write(OUT/'source-bytecode-inspection.json',dict(bytecode=bytecode,additional_sources=extra))
    ...
    result = dict(version='v3-pmx-step-diagnostic-v1',source_run=RUN,source_head=HEAD,
    ...
    result['execution'] = run_application_pmx(observer_jar,projection,OUT/'replay',limit=120)
    configs=[]
