...
import retain_v3_comparison_compact_v1 as retention
...
def audit(root, expected_run, expected_head):
    ...
    return dict(version='v3-compact-preflight-admission-audit-v1',qualified=True,run_id=expected_run,head=expected_head,protocol_sha256=retention.DESIGN_SHA,
