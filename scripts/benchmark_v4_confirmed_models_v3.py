...
CONFIG=Path('configs/v4_confirmed_performance_v3.json')
...
def prepare(profile,config):
    ...
    return selected,absent,dict(source_status=source_status,run_id=SOURCE_RUN,head=SOURCE_HEAD,artifacts=provenance,
