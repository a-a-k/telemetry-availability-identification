"""Verify the CUDD archive from compact documents and remote metadata."""
import argparse
...
import archive_v3_bdd_evidence_v1 as source
...
def main():
    ...
    require(run['path'] == '.github/workflows/v3-bdd-durable-archive-v1.yml'
    ...
    require(len(items) == 1 and items[0]['name'] == f'v3-bdd-archive-compact-{args.run}'
    ...
    require(manifest['version'] == 'v3-bdd-durable-archive-v1'
    ...
    for name in ('scripts/archive_v3_bdd_evidence_v1.py', 'scripts/archive_v3_main_evidence_v1.py',
                 'scripts/archive_h_exec_evidence_v1.py', 'scripts/retain_v3_comparison_compact_v4.py',
                 '.github/workflows/v3-bdd-durable-archive-v1.yml'):
    ...
    out = Path(f'docs/evidence/v3-bdd-durable-archive-{args.run}')
    ...
    record = dict(version='v3-bdd-archive-compact-retention-v1', archive_run=args.run,
