"""External Petclinic outcomes, independent of tracing and fitted models."""
import ast
import hashlib
import json
...
CONFIG = ROOT/'configs/petclinic_bootstrap.json'
...
def canonical(actual, expected):
    ...
    if isinstance(expected, dict):
        ...
        return {key: canonical(actual[key], value) for key, value in expected.items()}
