...
from .petclinic_contract import CONFIG, execute, finalize_write, fixture_from_source
...
''')
    common = {'server.port': 8080, 'spring.cloud.config.enabled': False,
        ...
        'management.tracing.enabled': False, 'management.endpoints.web.exposure.include': 'health,info',
